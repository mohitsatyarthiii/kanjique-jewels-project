...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErr(error.response?.data?.error || "Signup failed. Please try again.");
      setLoading(false);
    }
  };
      ...
      <div className="relative max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="hidden lg:block">
          ...
          <h1 className="text-4xl font-serif text-gray-900 leading-tight">
            Create Your Account
            <span className="block text-[#b2965a]">Begin Your Luxury Journey</span>
          </h1>

          <p className="mt-4 text-gray-600 max-w-md">
            Sign up to unlock exclusive collections, track your orders, and save your favorite jewellery pieces.
          </p>
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700">Exclusive member-only access</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-[#f4e6c3] rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 text-[#b2965a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700">Secure and private account</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full flex justify-center lg:justify-end">
          <div className="w-full max-w-sm rounded-3xl border border-black/5 bg-white/70 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] p-5 sm:p-6">
            <div className="text-center mb-5">
              <h2 className="text-xl font-serif text-gray-900 mb-1">Create Account</h2>
              <p className="text-sm text-gray-600">Join our premium jewellery community</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 text-[#b2965a] border-gray-300 rounded focus:ring-[#b2965a] focus:ring-2 focus:ring-offset-2"
                />
                <label htmlFor="terms" className="text-xs text-gray-600">
                  I agree to the{" "}
                  <a href="#" className="text-[#b2965a] hover:text-[#8c703f] font-medium">
                    Terms
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-[#b2965a] hover:text-[#8c703f] font-medium">
